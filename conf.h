...
class CIceIniFile
{
 ...
 private:
  ...
  ////////////////////////////////////////////////////////////
  //MODIFIED BY WP(wangpeng@software.ict.ac.cn) 2010-11-18
  ...
  static bool AscendingSectionSort(const Record Start,const  Record End)
  {
    return Start.Section < End.Section;
  }
  ...
  static	bool DescendingSectionSort(const Record& Start,const Record& End)
  {
    return Start.Section > End.Section;
  }
  ...
  static	bool AscendingRecordSort(const  Record Start,const  Record End)
  {
    return Start.Key < End.Key;
  }
  ...
  static	bool DescendingRecordSort(const Record Start,const Record End)
  {
    return Start.Key > End.Key;
  }
  ////////End of Mofified by WP///////////////////////////
};	
