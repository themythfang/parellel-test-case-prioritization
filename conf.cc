...
bool CIceIniFile::Load(string FileName, vector<Record>& content)
{
...
bool CIceIniFile::Save(string FileName, vector<Record>& content)
{
...
string CIceIniFile::Content(string FileName)
{
  ...
  if (Load(FileName, content))											// Make sure the file loads
    {
      for ( unsigned int i=0;i<content.size();i++)								// Loop through the content
        {
...
vector<string> CIceIniFile::GetSectionNames(string FileName)
{
...
vector<CIceIniFile::Record> CIceIniFile::GetSection(string SectionName, string FileName)
{
...
bool CIceIniFile::RecordExists(string KeyName, string SectionName, string FileName)
{
  vector<Record> content;													// Holds the current record													// Holds the current record
  ...
  if (Load(FileName, content))											// Make sure the file is loaded
    {
      vector<Record>::iterator iter = std::find_if(content.begin(), 
                                                   content.end(), 
                                                   CIceIniFile::RecordSectionKeyIs(SectionName,KeyName));			// Locate the Section/Key
...
bool CIceIniFile::SectionExists(string SectionName, string FileName)
{
  vector<Record> content;													// Holds the current record													// Holds the current record
  ...
  if (Load(FileName, content))											// Make sure the file is loaded
    {
      vector<Record>::iterator iter = std::find_if(content.begin(), 
                                                   content.end(), 
                                                   CIceIniFile::RecordSectionIs(SectionName));					// Locate the Section
...
vector<CIceIniFile::Record> CIceIniFile::GetRecord(string KeyName, string SectionName, string FileName)
{
  vector<Record> data;													// Holds the return data
  vector<Record> content;													// Holds the current record													// Holds the current record
  ...
  if (Load(FileName, content))											// Make sure the file is loaded
    {
      vector<Record>::iterator iter = std::find_if(content.begin(), 
                                                   content.end(), 
                                                   CIceIniFile::RecordSectionKeyIs(SectionName,KeyName));			// Locate the Record
...
string CIceIniFile::GetValue(string KeyName, string SectionName, string FileName)
{
...
bool CIceIniFile::SetValue(string KeyName, string Value, string SectionName, string FileName)
{
  vector<Record> content;													// Holds the current record													// Holds the current record
...
bool CIceIniFile::RenameSection(string OldSectionName, string NewSectionName, string FileName)
{
  vector<Record> content;													// Holds the current record													// Holds the current record
...
bool CIceIniFile::CommentRecord(CommentChar cc, string KeyName,string SectionName,string FileName)
{
  vector<Record> content;													// Holds the current record													// Holds the current record
...
bool CIceIniFile::UnCommentRecord(string KeyName,string SectionName,string FileName)
{
  vector<Record> content;													// Holds the current record													// Holds the current record
...
bool CIceIniFile::CommentSection(char CommentChar, string SectionName, string FileName)
{
  vector<Record> content;													// Holds the current record													// Holds the current record
...
bool CIceIniFile::UnCommentSection(string SectionName, string FileName)
{
  vector<Record> content;													// Holds the current record													// Holds the current record
...
bool CIceIniFile::DeleteRecord(string KeyName, string SectionName, string FileName)
{
  vector<Record> content;													// Holds the current record													// Holds the current record
...
bool CIceIniFile::DeleteSection(string SectionName, string FileName)
{
  vector<Record> content;													// Holds the current record													// Holds the current record
...
bool CIceIniFile::SetSectionComments(string Comments, string SectionName, string FileName)
{
  vector<Record> content;													// Holds the current record													// Holds the current record
...
bool CIceIniFile::SetRecordComments(string Comments, string KeyName, string SectionName, string FileName)
{
  vector<Record> content;													// Holds the current record													// Holds the current record
...
vector<CIceIniFile::Record> CIceIniFile::GetSections(string FileName)
{
  vector<Record> data;													// Holds the return data
  vector<Record> content;													// Holds the current record													// Holds the current record
...
bool CIceIniFile::Sort(string FileName, bool Descending)
{
  vector<CIceIniFile::Record> content;										// Used to hold the sorted content
  vector<CIceIniFile::Record> sections = GetSections(FileName);				// Get a list of Sections

  if(!sections.empty())													// Is there anything to process?
    {

      if(Descending)														// Descending or Ascending?
        std::sort(sections.begin(), sections.end(),CIceIniFile::DescendingSectionSort);
      else																// Sort the Sections
        std::sort(sections.begin(), sections.end(),CIceIniFile::AscendingSectionSort);
      ...
      for(vector<Record>::iterator iter = sections.begin(); iter < sections.end(); iter++) // For each Section
        {																		
          ...
          vector<CIceIniFile::Record> records = GetSection(iter->Section ,FileName); // Get a list of Records for this section
...
bool CIceIniFile::AddSection(string SectionName, string FileName)
{
  vector<Record> content;													// Holds the current record													// Holds the current record
...
bool CIceIniFile::Create(string FileName)
{
